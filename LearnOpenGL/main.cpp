...
int main(int argc, char* argv[])
{
	...
	Shader lightingShader("Shaders/Colors/vertexShader.vs", "Shaders/Colors/lightingShader.fs");
	Shader lightShader("Shaders/Colors/vertexShader.vs", "Shaders/Colors/lightShader.fs");
